...
DOWNLOADER_MIDDLEWARES = {
    'autohome_bbs_spider.middlewares.MyCustomDownloaderMiddleware': None,
    'autohome_bbs_spider.middlewares.JavaScriptMiddleware': 547,
}
ITEM_PIPELINES = {
    # 'autohome_bbs_spider.pipelines.AutohomeBbsSpiderPipeline': 1,
    'autohome_bbs_spider.pipelines.MySqlStorePipeline': None,
    'autohome_bbs_spider.pipelines.outputTextPipeline': 2,
